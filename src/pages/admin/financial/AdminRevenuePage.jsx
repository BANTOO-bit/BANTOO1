            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                ...
                <div className="flex items-center gap-3 w-full sm:w-auto">
                    <button
                        ...
                        disabled={exporting}
                        className="flex items-center justify-center gap-2 px-4 py-2 bg-primary hover:bg-blue-600 text-white font-medium rounded-lg text-sm transition-all duration-200 shadow-sm w-full sm:w-auto disabled:opacity-60"
                    >
