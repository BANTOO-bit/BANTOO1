...
export default function AdminSettingsPage() {
    ...
    return (
        <AdminLayout title="Pengaturan Sistem">
            {!isConfigured ? (
                <div className="flex flex-col items-center justify-center flex-1 bg-white dark:bg-[#1a2632] rounded-xl border border-[#e5e7eb] dark:border-[#2a3b4d] shadow-sm p-12 text-center min-h-[400px]">
