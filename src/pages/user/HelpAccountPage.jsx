...
function HelpAccountPage({ onNavigate }) {
            ...
            <main className="flex flex-col gap-6 px-4 pt-4">
                ...
                <section>
                    ...
                    <div className="flex flex-col gap-3">
                        <HelpOptionButton label="Saya lupa kata sandi" onClick={() => onNavigate?.('helpForgotPassword')} />
                        <HelpOptionButton label="Bagaimana cara mengubah profil?" onClick={() => onNavigate?.('helpEditProfile')} />
                        <HelpOptionButton label="Menjaga keamanan akun" onClick={() => onNavigate?.('helpAccountSecurity')} />
                        <HelpOptionButton label="Verifikasi email dan nomor HP" onClick={() => onNavigate?.('helpOtpIssues')} />
                        <HelpOptionButton label="Saya tidak menerima kode OTP" onClick={() => onNavigate?.('helpOtpIssues')} />
                        <HelpOptionButton label="Cara menghapus akun permanen" onClick={() => onNavigate?.('helpDeleteAccount')} />
                    </div>
                </section>
