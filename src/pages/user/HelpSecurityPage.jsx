...
function HelpSecurityPage({ onNavigate }) {
            ...
            <main className="flex flex-col gap-6 px-4 pt-4">
                ...
                <section>
                    ...
                    <div className="flex flex-col gap-3">
                        <HelpOptionButton label="Cara menjaga keamanan akun" onClick={() => onNavigate?.('helpAccountSecurity')} />
                        <HelpOptionButton label="Laporan aktivitas mencurigakan" onClick={() => handleQuestionClick("Laporan aktivitas mencurigakan")} />
                        <HelpOptionButton label="Kebijakan privasi Bantoo!" onClick={() => handleQuestionClick("Kebijakan privasi Bantoo!")} />
                        <HelpOptionButton label="Pengaturan izin lokasi & notifikasi" onClick={() => onNavigate?.('helpPermissions')} />
                    </div>
                </section>
