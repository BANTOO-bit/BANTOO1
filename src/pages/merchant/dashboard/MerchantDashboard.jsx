...
const WHATSAPP_SUPPORT = '6281234567890' // TODO: move to env/config
        ...
        <div className="bg-background-light dark:bg-background-dark text-text-main dark:text-gray-100 relative min-h-screen flex flex-col overflow-x-hidden pb-bottom-nav">
            ...
            <main className="flex flex-col gap-6 px-4 pt-2">
                ...
                <section className="flex flex-col items-center justify-center py-8 gap-5 mt-4 border-t border-border-color dark:border-gray-800">
                    ...
                    <button
                        onClick={() => window.open(`https://wa.me/${WHATSAPP_SUPPORT}?text=Halo%20Bantoo!%20Saya%20butuh%20bantuan`, '_blank')}
                        className="w-full max-w-sm bg-[#25D366] hover:bg-[#20bd5a] text-white rounded-full py-3.5 px-6 flex items-center justify-center gap-2.5 font-bold shadow-md active:scale-95 transition-all"
                    >
