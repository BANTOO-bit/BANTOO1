        ...
        <div className="bg-white dark:bg-[#1a2632] rounded-xl border border-[#e5e7eb] dark:border-[#2a3b4d] p-5 shadow-sm">
            ...
            {!hasData ? (
                <div className="flex flex-col items-center justify-center h-40 text-center">
                    <span className="material-symbols-outlined text-3xl text-[#d1d5db] dark:text-[#4a5568] mb-2">bar_chart</span>
                    <p className="text-sm font-medium text-[#9ca3af] dark:text-[#6b7280]">Belum ada data</p>
                    <p className="text-xs text-[#d1d5db] dark:text-[#4a5568] mt-0.5">Data akan muncul setelah ada pesanan</p>
                </div>
            ) : (
