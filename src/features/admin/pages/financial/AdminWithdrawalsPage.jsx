...
import AdminWithdrawalModal from '@/features/admin/components/AdminWithdrawalModal'
...
export default function AdminWithdrawalsPage() {
    ...
    const fetchWithdrawals = async () => {
        try {
            ...
            // Note: In a real app with many records, this should be a separate lightweight RPC call
