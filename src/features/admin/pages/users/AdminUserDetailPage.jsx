...
export default function AdminUserDetailPage() {
    ...
    const fetchUser = async () => {
        try {
            ...
            // Fetch order stats via adminService
            const orders = await adminService.getAdminOrders({ customerFilter: id })
    ...
    const breadcrumb = [
        ...
        { label: 'Pelanggan', path: '/admin/users' },
        { label: user.full_name || 'Pelanggan' }
    ]

    return (
        <AdminLayout title="Detail Pelanggan" showBack breadcrumb={breadcrumb}>
