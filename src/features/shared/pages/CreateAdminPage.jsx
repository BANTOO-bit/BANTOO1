...
import PhoneInput from '@/features/shared/components/PhoneInput'
...
export default function CreateAdminPage() {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            // Register admin via adminService
            await adminService.registerAdmin({ email, password, name, phone })
                ...
                <div className="bg-[#1a2632] border border-[#2a3b4d] rounded-2xl p-8 shadow-2xl">
                    ...
                    <form onSubmit={handleSubmit} className="space-y-4">
                        ...
                        <button
                            type="submit"
                            disabled={loading}
                            className="w-full h-12 bg-red-600 hover:bg-red-700 text-white font-bold rounded-xl active:scale-[0.98] transition-all flex items-center justify-center gap-2 disabled:opacity-50 disabled:cursor-not-allowed mt-2"
                        >
                            {loading ? (
