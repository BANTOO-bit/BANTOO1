            ...
            <main className="flex flex-col gap-6 px-4 pt-4">
                ...
                <section>
                    ...
                    <div className="flex flex-col gap-3">
                        <HelpOptionButton label="Mengatasi Gagal Transaksi" onClick={() => navigate('/help/payment/failed')} />
                        <HelpOptionButton label="Cara Isi Saldo" onClick={() => navigate('/help/payment/topup')} />
                        <HelpOptionButton label="Prosedur Refund Dana" onClick={() => navigate('/help/payment/refund')} />
                        <HelpOptionButton label="Metode Pembayaran Tersedia" onClick={() => navigate('/help/payment/methods')} />
                        <HelpOptionButton label="Kendala Voucher & Promo" onClick={() => navigate('/help/payment/voucher')} />
                    </div>
                </section>
