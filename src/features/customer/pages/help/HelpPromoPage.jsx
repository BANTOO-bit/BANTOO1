            ...
            <main className="flex flex-col gap-6 px-4 pt-4">
                ...
                <section>
                    ...
                    <div className="flex flex-col gap-3">
                        <HelpOptionButton label="Kenapa voucher tidak bisa dipakai?" onClick={() => navigate('/help/promo/voucher-issues')} />
                        <HelpOptionButton label="Promo khusus pengguna baru" onClick={() => navigate('/help/promo/new-user')} />
                        <HelpOptionButton label="Voucher hilang setelah dibatalkan" onClick={() => navigate('/help/promo/refunded-voucher')} />
                        <HelpOptionButton label="Promo menu khusus dari Warung" onClick={() => navigate('/help/promo/warung')} />
                    </div>
                </section>
                ...
                <section className="mt-4 pt-4 border-t border-dashed border-gray-200">
                    ...
                    <div className="flex flex-col gap-3">
                        {waNumber && (
                            <button
                                onClick={() => window.open(waLink('Halo! Saya butuh bantuan terkait Promo Bantoo'), '_blank')}
